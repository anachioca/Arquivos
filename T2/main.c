...
void leRegistroEImprime(FILE * binario, int rrn){
  baby = readRegistros(binario, i);
...
void pesquisaBin(void (*atuaNoBaby) (FILE *, int)){
  char arquivoGerado[128];
  scanf("%s", arquivoGerado);
...
int main(){
  ...
  switch(opcao){
    ...
    case 3:
      pesquisaBin(leRegistroEImprime);
      break;
